...
public class FriendRectclerAdapter extends RecyclerView.Adapter<FriendRectclerAdapter.FriendRecyclerViewHolder> {

    private List<FriendDTO> list;
    private RequestManager manager;

    public FriendRectclerAdapter(RequestManager manager) {
